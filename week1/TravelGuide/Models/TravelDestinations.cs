...
namespace TravelGuide.Models
{
    static public class TravelDestinations
    {
        static public List<Destination> Destinations { get; set; } = new List<Destination>()
        {
            ...
            new Destination("Hormuz Island, Iran", "https://i.pinimg.com/736x/20/17/d7/2017d72bcdc123c96806baa2c60cd13d.jpg")
        };

        static public Destination GetDestination(string desiredDest)
        {
            foreach (Destination dest in Destinations)
            {
                if (dest.Name == desiredDest)
                {
                    return dest;
                }
            }

...
namespace ASPIntroDemo.Models
{
    public class HomePage
    {
        ...
        public List<Destination> TravelDestinations { get; set; } = new List<Destination>
        {
        ...
        public HomePage(User tourist)
        {
            Tourist = tourist;
        }
        public HomePage(User tourist, List<Destination> travelDestinations)
        {
            Tourist = tourist;
